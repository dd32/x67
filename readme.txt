...
A plugin to mock/test a new UI for the WordPress updates screen.
...
**Contributing:** This plugin is available for forking/pull requests on [Github at dd32/x67](https://github.com/dd32/x67), all commits are sync'd to the WordPress.org plugin directory immediately.

**This plugin was last updated on %GITHUB_MERGE_DATETIME%**